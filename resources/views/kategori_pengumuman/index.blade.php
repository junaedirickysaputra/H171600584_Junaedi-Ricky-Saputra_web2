    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                <a href="{!! route('kategori_pengumuman.create')!!}" class="btn btn-primary ">{{ __('Tambah Data')}}</a>
                ...
                <table class="table table-bordered bg-white">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <a href="{!! route('kategori_pengumuman.show',[$item-> id]) !!}" button class="btn btn-sm btn-success">Lihat</a>
