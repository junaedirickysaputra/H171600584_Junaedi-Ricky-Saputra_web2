    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                <a href="{!! route('kategori_berita.create')!!}" class="btn btn-sn btn-primary">{{ __('Tambah Data')}}</a>
                ...
                <thead class ="bg-success">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <a href="{!! route('kategori_berita.show',[$item-> id]) !!}" button class="btn btn-sm btn-success">Lihat</a>
